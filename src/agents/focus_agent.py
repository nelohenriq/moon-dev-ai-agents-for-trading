...
class FocusAgent:
    def __init__(self):
        ...
        self.openai_client = openai.OpenAI(
            base_url="https://api.groq.com/openai/v1", api_key=openai_key
        )
        ...
        self.data_dir = Path(
            "/Users/md/Dropbox/dev/github/moon-dev-ai-agents-for-trading/src/data"
        )
        ...
        cprint(
            "📊 Focus history will be logged to: " + str(self.focus_log_path), "green"
        )
